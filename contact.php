...
if(isset($_POST['name']))
{
     /*if(mail("aminda.abeywardana@gmail.com","My subject","adwfawfwas","")){
        echo "send";
    }else
     echo "failed";*/
   ...
   // echo $name;
	$to = "aminda007@gmail.com";
	$subject = $_POST['subject'];
	$message = " Name: " . $name ."\r\n Email: " . $email . "\r\n Message:\r\n" . $message;
	 
	$from = "codemo.inc@gmail.com";
	$headers = "From:" . $from . "\r\n";
...
<head>
    ...
    <meta name="author" content="http://www.codemo.inc">
	
    <title>Nature Team | Contact Page</title>
	...
	<footer>
		<div class="wrap-footer">
			<div class="container">
				<div class="row">
					<div class="col-md-4">
						<div class="copyright">Copyright @ natureteam.mrt.ac.lk <br/><a href="http://www.365bootstrap.com" rel="nofollow" target="_blank">Bootstrap Themes</a> by 365Bootstrap.com</div>
					</div>
					<div class="col-md-4">
						<ul class="list-inline social-buttons">
							<li><a href="#"><i class="fa fa-twitter"></i></a>
